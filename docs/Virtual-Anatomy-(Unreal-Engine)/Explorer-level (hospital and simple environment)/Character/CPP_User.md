...
This actor is moved around the model of the human body based on which part of the body was selected. See [MeshSelector](../MeshSelection/MeshSelector.md) for more details.
...
The main purpose of this class is to highlight the objects that user has clicked on. See [MeshSelector](../MeshSelection/MeshSelector.md)
